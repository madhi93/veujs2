            ...
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    ...
                    <div class="kt-portlet">
                        ...
                        <!--begin::Form-->
                        <form class="kt-form" role="form" ref="editVisaFrom" name="editVisaFrom"
                            v-on:submit.prevent="editVisa">
                            ...
                            <div class="kt-portlet__foot">
                                <div class="kt-form__actions">
                                    <button type="button" @click="listVisa()"
...
<script>
    ...
    export default {
        ...
        methods: {
            getVisa: function () {
                axios.get('/admin/visa/fetch/' + this.$route.params.visa_id)
                    .then(r => r.data)
                    .then((response) => {
            ...
            editVisa: function () {
                axios.post('/admin/visa/edit/' + this.$route.params.visa_id, this.form)
                    .then(r => r.data)
                    .then((response) => {
                        this.errors = null;
                        this.listVisa();
