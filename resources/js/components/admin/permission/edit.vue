                    ...
                    <div class="col-md-6 offset-md-3">
                        ...
                        <div class="card card-default">
                            <div class="card-header">
                                <h3 class="card-title">Update Permission Form</h3>
                            </div>
                            <!-- /.card-header -->
    ...
    export default {
        ...
        methods: {
            getPermission: function () {
                axios.get('/admin/permission/fetch/' + this.$route.params.role_id)
                    .then(r => r.data)
                    .then((response) => {
            ...
            editPermission: function () {
                axios.post('/admin/permission/edit/' + this.$route.params.role_id, this.form)
                    .then(r => r.data)
                    .then((response) => {
                        this.errors = null;
                        this.listPermission();
