        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row" style="margin-bottom:20px;">
                    <div class="col-md-12">
                        <router-link tag="button" type="button"  :to="{ name:'createCategory'}" class="btn btn-primary float-right">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr v-for="(category , index) in categories" :key="category.id">
                                            ...
                                            <td>
                                                <span v-if="category.is_gift == 1" class="badge badge-success">
                                                    Yes
                                                </span>
                                                <span v-if="category.is_gift == 0" class="badge badge-danger">
                                                    No
                                                </span>
                                            </td>
                                            <td>
                                                <router-link tag="button" type="button"
                                                    ...
                                                    :to="{ name:'editCategory', params: { 'category_id': category.id }}">
                                        ...
                                        <tr v-show="!categories.length">
                                            <td colspan="7" class="no-data-found-info">No admin categories found</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
    ...
    export default {
        ...
        methods: {
            ...
            searchcategories: function (page) {
                axios.post('/product-category/search/' + page, this.filter)
                    .then(r => r.data)
                    .then((response) => {
                        this.categories = response.data;
                        this.totalItems = response.totalItems;
