    ...
    <div class="">
        ...
        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
            <div class="kt-portlet kt-portlet--mobile">
                ...
                <div class="kt-portlet__body kt-portlet__body--fit table-cotainer">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <tr v-for="(plan , index) in plans" :key="plan.id">
                                ...
                                <td>{{ plan.group }}</td>
                                <td>
                                    <router-link tag="button" type="button" class="btn btn-sm btn-icon btn-info"
                                        :to="{ name:'editPlan', params: { 'plan_id': plan.id }}">
                            ...
                            <tr v-show="!plans.length">
                                <td colspan="7" class="no-data-found-info">No Plan found</td>
                            </tr>
                        </tbody>
                    </table>
                    <nav>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            searchInvoices: function (page) {
                axios.post('/admin/plan/search/' + page, this.filter)
                    .then(r => r.data)
                    .then((response) => {
                        this.plans = response.data;
                        this.totalItems = response.totalItems;
            ...
            OrderBy: function (orderby) {
                ...
                this.searchInvoices(1);
            },
            remove: function (id, index) {
                axios.delete('/admin/plan/remove/' + id)
                    .then(r => r.data)
                    .then((response) => {
