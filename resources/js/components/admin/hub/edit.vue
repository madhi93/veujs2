                    ...
                    <div class="col-md-6 offset-md-3">
                        ...
                        <div class="card card-default">
                            <div class="card-header">
                                <h3 class="card-title">Edit Hub Form</h3>
                            </div>
                            <!-- /.card-header -->
                            <form role="form" ref="editHubFrom" name="editHubFrom" v-on:submit.prevent="editHub">
                                <div class="card-body">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getHub: function () {
                axios.get('/delivery-hub/fetch/' + this.$route.params.hub_id)
                    .then(r => r.data)
                    .then((response) => {
            ...
            editHub: function () {
                axios.post('/delivery-hub/edit/' + this.$route.params.hub_id,this.form)
                    .then(r => r.data)
                    .then((response) => {
                        this.errors = null;
                        this.listHub();
