                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" v-model="form.name"
                                            placeholder="Shop Category Name" required>
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="card card-default">
                            ...
                            <div class="card-body">
                                ...
                                <avatar-cropper :labels="{ submit: 'submit', cancel: 'Cancle'}"
                                    ...
                                    upload-url="/shop-category/feature-image/upload"
    ...
    export default {
        ...
        data() {
            return {
                ...
                fileObject: null,
                dropzoneOptions: {
                    url: 'shop-category/images/upload',
                    thumbnailWidth: 150,
                    maxFilesize: 0.5,
                    addRemoveLinks: true,
        ...
        methods: {
            ...
            removeImage(id) {
                axios.delete('/shop-category/remove-image/' + id)
                    .then(r => r.data)
                    .then((response) => {
                        this.getCategory();
                    });
            ...
            getCategory: function () {
                axios.get('/shop-category/fetch/' + this.$route.params.category_id)
                    .then(r => r.data)
                    .then((response) => {
            ...
            editCategory: function () {
                axios.post('/shop-category/edit/' + this.$route.params.category_id, this.form)
                    .then(r => r.data)
                    .then((response) => {
                        this.errors = null;
