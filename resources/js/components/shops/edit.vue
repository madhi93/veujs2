            ...
            <div class="container-fluid">
                        ...
                        <div class="card card-default">
                            ...
                            <div class="card-body">
                                ...
                                <avatar-cropper :labels="{ submit: 'submit', cancel: 'Cancle'}"
                                    ...
                                    upload-url="/shop/feature-image/upload"
                ...
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                        ...
                        <button type="button" @click="editShop()" class="btn btn-success float-right">Update</button>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
    ...
    export default {
        ...
        methods: {
            handleUploading(form, xhr) {
                form.append('shop_id', this.$route.params.shop_id);
            },
            ...
            removeImage(id) {
                axios.delete('/shop/remove-image/' + id)
                    .then(r => r.data)
                    .then((response) => {
                        this.getShop();
                    });
            ...
            getcategories: function () {
                axios.get('/shop/categories/fetch')
                    .then(r => r.data)
                    .then((response) => {
